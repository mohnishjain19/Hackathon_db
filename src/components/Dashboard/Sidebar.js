...
const Sidebar = (props) => {
    return (
         <div className="col-md-3 col-lg-2 sidebar-offcanvas pl-0 sidebar-container" id="sidebar" role="navigation" style={{backgroundColor:"#e9ecef", height: "100%"}}>
            <ul className="nav flex-column sticky-top pl-0 pt-5 p-3 mt-3">
                ...
                {props.isManager && <li className="nav-item mb-2" id="UserList"><a class="nav-link text-secondary" href="#" id="AssignBonds" onClick={props.changePage}><i class="fas fa-tablet-alt font-weight-bold"></i><span className="ml-3">Assign Bonds</span></a></li>}
